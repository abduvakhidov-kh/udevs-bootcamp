...
export default function Footer() {
  return (
    <div className={styles.footer}>
      <div className={`_container ${styles.footer__container}`}>
        <ul className={styles.footer__list}>
          <li className={styles.footer__item}>
            <ul className={`${styles.footer__links} ${styles.footer__company}`}>
              <li
                className={`${styles.footer__links__item} ${styles.footer__logo}`}
              >
                <img
